      ...
      <el-col :md="9" :sm="24" class="phone-margin">
        <template v-if="contests.length">
          <el-card>
            <div slot="header" class="clearfix title content-center">
              <div class="home-title home-contest">{{ $t('m.Recent_Contest') }}</div>
            </div>
            <el-card
              shadow="hover"
        ...
        <el-card :class="contests.length ? 'card-top' : ''">
          ...
          >
            ...
            <vxe-table-column field="total" :title="$t('m.Total')" min-width="50" align="left"></vxe-table-column>
          </vxe-table>
        </el-card>
        <el-card class="card-top">
          <div slot="header" class="clearfix title">
            <span class="home-title panel-title">{{ $t('m.Supported_Remote_Online_Judge') }}</span>
          </div>
          <el-row :gutter="20">
...
const Announcements = () => import("@/components/core/common/Announcements.vue");
export default {
  name: "home",
  components: {
    Announcements,
