...
// import elenUS from 'ElementPlus/lib'
// import elzhCN from 'ElementPlus/lib/locale/lang/zh-CN'
...
const languages = [
  { value: 'en-US', label: 'English', vxe: { ...vxeEnUS } },
  { value: 'zh-CN', label: '简体中文', vxe: { ...vxeZhCN } },
