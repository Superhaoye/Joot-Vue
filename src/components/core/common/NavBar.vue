  ...
  <div>
    <div id="header" v-if="!mobileNar">
      ...
      >
        ...
        <template v-else>
          <el-dropdown class="drop-menu" @command="handleRoute" placement="bottom" trigger="click">
    ...
    <el-dialog :visible.sync="modalVisible" width="370px" class="dialog" :title="title">
...
<script>
import Login from "@/components/core/common/Login.vue";
import Register from "@/components/core/common/Register.vue";
import ResetPwd from "@/components/core/common/ResetPassword.vue";
import MsgSvg from "@/components/core/msg/msgSvg.vue";
